...
from api.routes import auth, users, categories, products, address, carts, reviews, orders, product_image, promocode, wishlist, contact
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://e-com-frontend-b5d3.onrender.com"],  # Allow frontend domain
